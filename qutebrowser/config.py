...
c.aliases['reload'] = 'config-source'
c.fonts.default_family = 'EnvyCodeR Nerd Font'
...
# startpage = 'C:/Users/Java/Downloads/GitHub/totp-generator/public/index.html'
...
c.editor.command = ['wezterm', 'start', 'nvim', '{file}', '+startinsert', '+call cursor({line}, {column})']
c.hints.mode = 'letter'
# c.hints.dictionary = './words'
...
# Color of the scrollbar handle in the completionview.
...
# Background color of the context menuâ€™s selected item. If set to null, the Qt default is used.
c.colors.contextmenu.selected.bg = bg2

#Foreground color of the context menuâ€™s selected item. If set to null, the Qt default is used.
